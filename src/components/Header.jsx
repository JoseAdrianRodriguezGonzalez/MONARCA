    ...
    <div className="container bg-black flex flex-row">
      <nav className="container flex flex-row">
        <div className="container w-1/2 flex flex-row items-center">
          <img className="h-[12vh] w-[30vw] md:h-[16vh] md:w-[20vw]" src="/src/assets/MONARCA_BLANCA - copia.png" alt="" />
          <img className="h-[8vh] w-[40vw] md:h-[8vh] md:w-[30vw]" src="/src/assets/MONARCA_BLANCA - copia (2).png" alt="" />
        </div>
